...
package com.elpida.placepicker;
...
import com.elpida.placepicker.cardstream.Card;
import com.elpida.placepicker.cardstream.CardStream;
import com.elpida.placepicker.cardstream.CardStreamFragment;
import com.elpida.placepicker.cardstream.OnCardClickListener;
...
public class PlacePickerFragment extends Fragment implements OnCardClickListener {
    ...
    public void onResume() {
        ...
        // tsekarw an h karta fainetai, toulaxiston na fainetai kenooo.
        CardStreamFragment stream = getCardStream();
        if (stream.getVisibleCardCount() < 1) {
            // an den fainontai na anoiksei mono thn prwti.
            // initial oles kai proetoimasia tis arxikis.
            initialiseCards();
            // na fanei karta picker kai na min tin parei.
    ...
    public void onCardClick(int cardActionId, String cardTag) {
        if (cardActionId == ACTION_PICK_PLACE) {
            ...
            try {
                ...
                Toast.makeText(getActivity(), "Google Play Services μη διαθέσιμο.",
                        Toast.LENGTH_LONG)
                        .show();
            }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_PLACE_PICKER) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                Log.d(TAG, "Μέρος που επιλέχτηκε: " + placeId + " (" + name.toString() + ")");

                // emfanisi kartas.
                getCardStream().showCard(CARD_DETAIL);

            } else {
                // an o xristis den epileksei kati krypse karta.
    ...
    /**
     *  kanei initial ton picker kai tis kartes me ta stoixeia ola popa  kai ta prosthetei sto card stream
     */
    private void initialiseCards() {
        // prosthese picker card.
        ...
        // prosthese kai provalle thn eisagwgiki me ta mpourou mpourou.
